...
from utils_ad import download_data, train, acc_calc, pickle_dump
...
if __name__ == "__main__":
    ...
    for i, monte_carlo_seed in enumerate(monte_carlo_seeds):
        ...
        train(model = model, optimizer = optimizer, loss_func = loss,
